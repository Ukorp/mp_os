    ...
    char **argv)
{
    ...
    std::string const test("1234354131413414141412421");
    big_integer bgint1("1234354131413414141412421");
    big_integer bgint2("1234354131413414141412421");
    big_integer result(bgint1);

    std::cout << (result == bgint1) << std::endl;
}