...
public:
    ...
    public:
        ...
        iterator_data(): depth(-1), key(), value()
        {
        ...
        iterator_data(
            const iterator_data & other): depth(other.depth), key(other.key), value(other.value)
        {
            
        }

        iterator_data(
            iterator_data && other): depth(std::move(other.depth)), key(std::move(other.key)), value(std::move(other.value))
        {
            
        }

        iterator_data& operator=(
            const iterator_data & other) 
            {
                if (this != &other)
                {
                    depth = other.depth;
    ...
    public:
        bool operator==(iterator_data const & other)
        {
            return ((other.depth == depth) && (other.key == key) && (other.value == value)) ? true : false;
        }
    ...
    public:
        ...
        explicit prefix_iterator(
                ...
                iterator_data* data
                ): holder(holder), _state(state), _data(data)
        {
    ...
    public:
        ...
        prefix_iterator &operator++(); // later
        
        prefix_iterator const operator++( // later
            int not_used);
    ...
    private:
        ...
        void assign_data()
        {
            _data->key = _state.top()->key;
            _data->value = _state.top()->value;
            holder->inject_additional_data(_data, _state.top());
        }
        
    public:

        prefix_iterator(prefix_iterator const &other): holder(other.holder), _data(other._data), _state(other._state)
        {

        }

        prefix_iterator(prefix_iterator &&other): holder(other.holder), _data(other._data), _state(std::move(other._state))
        {
            other._data = nullptr;
    ...
    public:
        ...
        prefix_reverse_iterator(const prefix_reverse_iterator  &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        prefix_const_reverse_iterator(prefix_const_reverse_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        explicit infix_iterator(
                ...
                std::stack<node*> state,
                iterator_data * data
                ): _data(data), _state(state), _holder(holder)
        {
            if (_state.empty())
            {
                return;
    ...
    public:
        ...
        infix_iterator(infix_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {

        }
        infix_iterator &operator=(infix_iterator const& other) noexcept
        {
            if(this != &other)
            {
                this->_holder = other._holder;
    ...
    public:
        ...
        infix_const_iterator(infix_const_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {

        }
        infix_const_iterator &operator=(infix_const_iterator const& other) noexcept
        {
            if(this != &other)
            {
                this->_holder = other._holder;
    ...
    public:
        ...
        infix_reverse_iterator(infix_reverse_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        infix_const_reverse_iterator(infix_const_reverse_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        postfix_iterator(postfix_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        postfix_const_iterator(postfix_const_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
    ...
    public:
        ...
        postfix_reverse_iterator(postfix_reverse_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {

        }
        postfix_reverse_iterator &operator=(postfix_reverse_iterator const& other) noexcept
        {
            if(this != &other)
            {
                this->_holder = other._holder;
    ...
    public:
        ...
        postfix_const_reverse_iterator(postfix_const_reverse_iterator const &other): _holder(other._holder), _data(other._data), _state(other._state)
        {
...
protected:
        ...
        node * &subtree_root)
    {
        ...
        allocator::destruct(subtree_root);
            ...
            node const *subtree_root)
    {
        ...
        copy_additional_data(subtree_root, subtree_root_copied); //not implemented
...
binary_search_tree<tkey, tvalue>::prefix_iterator::prefix_iterator(
    binary_search_tree<tkey, tvalue> * holder,
    typename binary_search_tree<tkey, tvalue>::node *subtree_root,
    iterator_data * data) : holder(holder), _data(data)
{
    if (subtree_root)
    {
        ...
        _data->key = _state.top()->key;
        _data->value = _state.top()->value;
        this->holder->inject_additional_data(_data, _state.top());
        _data->depth = 0;
    }
}
...
{
    if(this->_state.empty() && other._state.empty()) return true;
...
typename binary_search_tree<tkey, tvalue>::prefix_iterator &binary_search_tree<tkey, tvalue>::prefix_iterator::operator++()
{
    if (_state.empty())
    {
        std::logic_error("Incrementing empty iterator");
        return *this;
    }
...
{
    if(_state.empty()) std::logic_error("Empty iterator!!!");
    return _data;
}
...
{
    if(this->_state.empty()) std::logic_error("Empty iterator!!");
    return _data;
}
...
binary_search_tree<tkey, tvalue>::prefix_const_reverse_iterator::prefix_const_reverse_iterator(
    binary_search_tree<tkey, tvalue>* holder,
    typename binary_search_tree<tkey, tvalue>::node *subtree_root,
    iterator_data* data): _data(data), _holder(holder)
{
    if(subtree_root)
    {
        _state.push(subtree_root);
...
typename binary_search_tree<tkey, tvalue>::iterator_data *binary_search_tree<tkey, tvalue>::infix_iterator::operator*() const
{
    if (_state.empty())
    {
        throw std::logic_error("Can't get data from iterator");
    }
    return _data;
}
...
{
    if(_state.empty())
       throw std::logic_error("Iterator is empty!");
    return _data;
}
        ...
        typename binary_search_tree<tkey, tvalue>::infix_reverse_iterator const &other) const noexcept
{
    ...
    return this->_state.top() == other.top();
}
...
{
    if(_state.empty()) throw std::logic_error("Iterator is empty!");
...
{
    if(_state.empty())  throw std::logic_error("Empty iterator!!");
...
{
    if(_state.empty() && other._state.empty()) return true;

    if(_state.empty() ^ other._state.empty()) return false;

    return _state.top() == other.top();
}
